...
var PathOrganizationSvcGetOrganization = "/organization/:organizationId"
...
type OrganizationSvcBMServer interface {
	...
	GetOrganization(ctx context.Context, req *google_protobuf1.Empty) (resp *Organization, err error)
}
...
func RegisterOrganizationSvcBMServer(e *bm.Engine, server OrganizationSvcBMServer) {
	...
	e.GET("/organization/:organizationId", organizationSvcGetOrganization)
}
